///////////////////////////////////////////////////////////////////////////////
// Filename:    Log.h
// Description: there is a log system header for the MODEL CONVERTER
///////////////////////////////////////////////////////////////////////////////
#pragma once
...
public:
	...
	static void Debug(const char*, int, const std::string & message);
	static void Debug(const char*, int, const char* message); // pring a debug message
